                                    ...
                                    <div class="block_content">
                                        <div class="effect">
                                            <a href="#"> <img class="img-fluid"
                                                              src="{{asset('assets/front/img/1.jpg')}}"
                    ...
                    <div class="nov-row spacing-30 mt-15 col-lg-12 col-xs-12" ><div class="nov-row-wrap row">
                            ...
                            <div class="nov-image col-lg-4 col-md-4">
                                <div class="block">
                                    <div class="block_content">
                                        <div class="effect">
                                            <a href="#"> <img class="img-fluid" src="{{('assets/front/modules/novpagemanage/img/9f5a7c1afb433543e3138412909ebf5b.jpg')}}" alt="banner3-3" title="banner3-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
