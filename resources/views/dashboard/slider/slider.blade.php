                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">   {{__('admin/dashboard.slider_data')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  {{__('admin/dashboard.slider_upload_img')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.sliders.save-db')}}" method="POST" enctype="multipart/form-data">
                                            @csrf

                                                    <div class="form-group">
                                                        <label for="document">{{__('admin/dashboard.slider_img')}}</label>
                                        ...
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin/dashboard.slider_img')}}</th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <figure class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope=""
                                                                ...
                                                                <a href="{{asset('assets/images/sliders/'.$image->image)}}" itemprop="contentUrl"
                                                                   data-size="480x360">
                                                                    <img class="img-thumbnail img-fluid"
                                                                         src="{{asset('assets/images/sliders/'.$image->image)}}"
                                                                         itemprop="thumbnail" alt="{{__('admin/dashboard.slider_img')}}">
                                                                </a>
                                                            </figure>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.sliders.delete-images',$image -> id)}}"
