        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/dashboard.index_tag')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/dashboard.index_category_dashboard')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/dashboard.index_tag')}} </li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/dashboard.index_all_tags')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin/dashboard.index_tag_name')}} </th>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        {!! $tags->appends(['sort' => 'science-stream'])->links() !!}
                                    </div>
