                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/dashboard.index_category_dashboard')}} </a>
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.tags')}}">{{__('admin/dashboard.index_all_tags')}} </a></li>
                                    <li class="breadcrumb-item active">{{__('admin/dashboard.index_add_tag')}} </li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/dashboard.index_add_tag')}}</h4>
