                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/dashboard.index_pro_update_price')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="form-body">
                                            <form class="form"
                                                  action="{{route('admin.products.general.update-price',$product->id)}}"
                                                  method="POST"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="special_price_type" class="select2 form-control" >
                                                                <option value="percent" @if($product->special_price_type == 'percent') selected @endif>{{__('admin/dashboard.pro_price_precent')}}</option>
                                                                <option value="fixed" @if($product->special_price_type == 'fixed') selected @endif>{{__('admin/dashboard.pro_price_fixed')}}</option>
