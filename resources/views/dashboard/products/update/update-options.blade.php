                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">   {{__('admin/dashboard.index_pro_update_product')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/dashboard.index_pro_update_option')}} </h4>
                                    ...
                                    <div>
                                        <a href="{{route('admin.products')}}"
                                           class="btn btn-primary float-right mr-5 mb-4" style="margin-top: 20px">{{__('admin/dashboard.index_all_pro')}}</a>
                                    </div>
                                </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="form-body">
                                            <form class="form"
                                                  action="{{route('admin.products.add-options',$product->id)}}"
                                                  method="POST"
                                                  enctype="multipart/form-data">
                                                @csrf

                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="ft-home"></i>   {{__('admin/dashboard.pro_addition_option_data')}} </h4>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                        ...
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin/dashboard.pro_option')}} </th>
                                                <th>{{__('admin/dashboard.pro_option_price')}}</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.products.edit-options',[$product->id,$option -> id])}}"
                                                                ...
                                                                <a href="{{route('admin.products.delete-options',[$product->id,$option -> id])}}"
