                  ...
                  <span
                      class="user-name text-bold-700">  {{auth('admin')->user()->name}}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}"><i
                                    class="ft-user"></i>{{__('admin/dashboard.admin_edit_profile')}} </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}"><i class="ft-power"></i>
                                {{__('admin/dashboard.admin_logout')}} </a>
                        </div>
                    </li>
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            @foreach($langs=getLanguages() as $localeCode => $properties)
                                <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                    {{ $properties['native'] }}
                                </a>
                                <div class="dropdown-divider {{$properties==end($langs)?'d-none':''}}"></div>
                            @endforeach
                        </div>
                    </li>
