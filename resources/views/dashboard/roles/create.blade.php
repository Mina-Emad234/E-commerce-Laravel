                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.roles')}}">
                                        {{__('admin/dashboard.index_role')}} </a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/dashboard.index_add_role')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/dashboard.index_add_role')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> {{__('admin/dashboard.index_data_role')}} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
