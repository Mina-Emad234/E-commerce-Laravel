...
class EditProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "current_password"=>['nullable','required_with:password',new CurrentPassword()],
    ...
    public function messages()
    {
        return [
            ...
            "current_password.required_with"=>__('admin/dashboard.edit_profile_current_pass_require'),
